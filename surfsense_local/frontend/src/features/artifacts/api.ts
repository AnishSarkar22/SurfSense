...
export function listFormats(
  ...
  return requestJson<ArtifactFormat[]>(
    `/workspaces/${workspaceId}/artifacts/formats`,
    { signal }
  )
}
...
export function createJob(
  ...
  return requestJson<Artifact>(`/workspaces/${workspaceId}/artifacts/jobs`, {
    method: "POST",
