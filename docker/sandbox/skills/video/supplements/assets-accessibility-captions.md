# Assets, accessibility, and captions

Every asset must earn its place and remain understandable.

- Use only provided or admitted asset references. Never invent a path, fetch a
  remote substitute, or assume an unlisted font or icon exists.
- Preserve aspect ratio and important crop regions. Prefer a clear crop to a
  distorted or unreadably small asset.
- Treat logos, screenshots, charts, and quoted material accurately. Keep
  attribution when the source requires it and avoid decorative alteration that
  changes meaning.
- Ensure meaningful visuals are explained by narration, captions, or nearby
